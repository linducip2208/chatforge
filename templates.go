...
{{template "sgroup" dict "id" "channels" "icon" "la-plug" "label" (T "sg_channels")}}
  ...
  <li class="nav-item"><a class="nav-link {{if eq .Active "meta_flows"}}active{{end}}" href="/pro/meta/flows"><i class="la la-stream la-lg"></i> WA Flows<span class="badge ms-1" style="background:#4F46E5;color:#fff;font-size:8px">META</span></a></li>
  <li class="nav-item"><a class="nav-link {{if eq .Active "meta_catalog"}}active{{end}}" href="/pro/meta/catalog"><i class="la la-tags la-lg"></i> Catalog<span class="badge ms-1" style="background:#4F46E5;color:#fff;font-size:8px">META</span></a></li>
  <li class="nav-item"><a class="nav-link {{if eq .Active "meta_calling"}}active{{end}}" href="/pro/meta/calling"><i class="la la-phone la-lg"></i> WA Calling<span class="badge ms-1" style="background:#4F46E5;color:#fff;font-size:8px">NEW</span></a></li>
